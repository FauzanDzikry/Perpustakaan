      ...
      <div id="content">
        ...
        <div class="container">
          <section class="content text-center">
            @yield('content')
            <h2 style="text-align: center; margin-bottom:100px;">Selamat Datang di Web Perpustakaan</h2>

            <a class="btn btn-info mr-5" href="{{ route('books.index') }}">Data Buku</a>
            <a class="btn btn-info mr-5" href="{{ route('borrowings.index') }}">Data Peminjam</a>
            <a class="btn btn-info" href="{{ route('students.index') }}">Data Siswa</a>
        </section>
